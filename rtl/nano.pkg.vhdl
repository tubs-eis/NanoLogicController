...
package nano_pkg is
  ...
  constant NANO_I_ADR_W_C          : integer := 16;              -- Instruction Memory Address Width
  constant NANO_I_D_C              : natural := 2**15;
  constant REGISTER_ADDR_WIDTH     : integer := 12;
  constant REGISTER_WIDTH          : natural := 2**9;
  ...
  constant SIMPLE_SHIFT_ADDR_WIDTH : integer := 8;
  constant TEMP_REG_ADDR_WIDTH     : INTEGER := 12;
  constant TEMP_REG_WIDTH          : natural := 2**11;
  ...
  constant CW_TEMP_REG_COPY : natural := CW_TEMP_REG_EN + 1;
  constant CW_TEMP_REG_ADDR : natural := CW_TEMP_REG_COPY + 1;
  ...
  constant OP_EOC      : std_logic_vector(NANO_I_W_C -1 downto 0) := "0100";
  ...
  constant OP_SHIFTREG_COPY        : std_logic_vector(SHIFTREG_I_W_C -1 downto 0) := "101";
